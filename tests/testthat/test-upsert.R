...
test_that(".db_relation_cols retrieves column names", {
  ...
  cols <- csolake:::.db_relation_cols(con, "test", "main", "products")
...
test_that(".db_table_exists returns TRUE for existing table", {
  ...
  expect_true(csolake:::.db_table_exists(con, "test", "main", "items"))
  expect_false(csolake:::.db_table_exists(con, "test", "main", "nonexistent"))
